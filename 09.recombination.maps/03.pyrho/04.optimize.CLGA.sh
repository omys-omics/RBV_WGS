...
chromosomes="CM105775.1 CM105784.1 CM105786.1"
...
vcf=/kuhpc/scratch/bi/b686w673/009.RBV.WGS/09.recombination.maps/03.pyrho/$species/vcfs/$species.$chromosome.vcf.gz
table_file=/kuhpc/scratch/bi/b686w673/009.RBV.WGS/09.recombination.maps/03.pyrho/$species/$species.lookuptable.hdf

pyrho optimize --numthreads 12 --logfile 03.optimize.$species.logfile \
  --vcffile $vcf \
  --windowsize 50 \
  --blockpenalty 15 \
