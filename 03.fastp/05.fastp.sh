...
INDIR=/kuhpc/scratch/bi/b686w673/009.RBV.WGS/01.raw.reads/20250611_NX2K-P4-PE150_BJW-RBV-WGS-5/20250611_NX2K-P4-PE150_BJW-RBV-WGS-5-Colella_FASTQ
OUTDIR=/kuhpc/scratch/bi/b686w673/009.RBV.WGS/03.fastp
#mkdir $OUTDIR

# get all fastq files
FNs=`ls $INDIR/FN*.fastq.gz`
UAMs=`ls $INDIR/UAM*.fastq.gz`
fastqs=`echo $FNs $UAMs`
