...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=outputs/out.%j.gapperi.txt
#SBATCH --array=1-15
...
in_dir=/kuhpc/scratch/bi/b686w673/009.RBV.WGS/11.mitogenomes/alignments


samtools consensus -r NC_068811 $in_dir/$ID.sorted.bam | sed "s/^>NC_068811/>$ID/" > mitogenome/$ID.mitogenome.fasta 
