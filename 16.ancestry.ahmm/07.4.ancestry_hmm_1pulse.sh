...
mkdir $out_dir/$geo.1pulse.hi.ne.AIM10.CLGAr
cd $out_dir/$geo.1pulse.hi.ne.AIM10.CLGAr
pwd
...
$ancestry_hmm -i $input_file -s $ploidy_file -a 2 $rut $gap -p 1 10000000 $gap -p 0 -100 $rut --tmax 1000000 --tmin 1 -b 1000 1000 --ne 90166
